...
//import com.gloomme.authservice.exceptions.UserNotFoundException;
...
//        registerUserAccountDTO.setFirstName("David");
//        registerUserAccountDTO.setLastName("Rosemary");
//        registerUserAccountDTO.setEmail("David.test@gmail.com");
//        registerUserAccountDTO.setGender("MALE");
//        registerUserAccountDTO.setUsername("David");
//        registerUserAccountDTO.setPassword("Test!123");
//
//        User createdUser = userService.registerUserAccount(registerUserAccountDTO);
//
//        assertNotNull(createdUser);
//        assertEquals("David", createdUser.getFirstName());
//        assertEquals("Rosemary", createdUser.getLastName());
//        assertEquals("David.test@gmail.com", createdUser.getContact().getEmail());
...
//        createOrUpdateUserDTO.setFirstName("John");
//        createOrUpdateUserDTO.setLastName("Rosemary");
...
//        updateUserDTO.setFirstName("Musa");
//        updateUserDTO.setLastName("John");
//        updateUserDTO.setEmail("Musa.test@gmail.com");
//        updateUserDTO.setGender("MALE");
//        updateUserDTO.setUsername("Musa");
...
//        assertEquals("Musa", updatedUser.getFirstName());
//        assertEquals("John", updatedUser.getLastName());
//        //
//        assertEquals("Musa.test@gmail.com", updatedUser.getContact().getEmail());
//        assertEquals("Musa", updatedUser.getUsername());
